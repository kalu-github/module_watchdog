...
final class WatchdogBroadcastManager {
    ...
    private static WatchdogBroadcastManager mInstance;

    @NonNull
    public static WatchdogBroadcastManager getInstance(@NonNull Context context) {
        synchronized (mLock) {
            if (mInstance == null) {
                mInstance = new WatchdogBroadcastManager(context.getApplicationContext());
            }
            return mInstance;
        }
    }

    private WatchdogBroadcastManager(Context context) {
        mAppContext = context;
